...
* Студент: [Неопознанный енот](https://up.htmlacademy.ru/htmlcss/28/user/919923).
* Наставник: `Константин Соколов`.

 Ссылка на профиль: `https://htmlacademy.ru/profile/costigans`.---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/919923-technomart-28) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
